...
//            setScrollStateIdle()
    ...
    fun getTopView(): View? {
        val currPosition = mTotalOffset / mItemWidth
        val anchorView = mRecycler?.getViewForPosition(currPosition)
        val tag =  anchorView?.getTag()
        Log.e("holder", "currPosition: ${currPosition}, TopView ${tag}")
        return anchorView
    }
    ...
    class StackConfig {
        ...
        var isAdjustSize = true // 是否重新校准调整RecyclerView宽高
